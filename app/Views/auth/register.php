...
<body>
    <div class="flex h-[700px] w-full">
        ...
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <form action="/registered" method="post" class="md:w-96 w-80 flex flex-col items-center justify-center">
                <?= csrf_field() ?>
                <h2 class="text-4xl text-gray-900 font-medium">Sign Up</h2>
                <p class="text-sm text-gray-500/90 mt-3">Please sign up to continue</p>
                ...
                <div class="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                    ...
                    <input type="email" name="email" placeholder="Email" class="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required>
                </div>
                <div class="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                    <svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 .55.571 0H15.43l.57.55v9.9l-.571.55H.57L0 10.45zm1.143 1.138V9.9h13.714V1.69l-6.503 4.8h-.697zM13.749 1.1H2.25L8 5.356z" fill="#6B7280" />
                    </svg>
                    <input type="text" name="username" placeholder="Username" class="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required>
                </div>
                ...
                <p class="text-gray-500/90 text-sm mt-4">have an account? <a class="text-indigo-400 hover:underline" href="#">Sign in</a></p>
            </form>
        </div>
    </div>
</body>
